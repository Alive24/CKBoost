...
export const {`;
  ...
  const jsPath = path.join(__dirname, '../lib/generated/ckboost.js');
  let functionNames = [];
...
function main() {
  const jsonPath = path.join(__dirname, '../lib/generated/ckboost.json');
  const outputPath = path.join(__dirname, '../lib/generated/ckboost.d.ts');
  const indexPath = path.join(__dirname, '../lib/generated/index.ts');
  ...
  try {
    ...
    console.error('4. Check file permissions in lib/generated directory');
